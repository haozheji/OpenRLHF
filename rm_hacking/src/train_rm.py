...
def train(args):
    ...
    train_data = load_dataset(args.dataset, split=args.train_split)
    eval_data = load_dataset(args.dataset, split=args.eval_split)
    train_dataset = RewardDataset(train_data, tokenizer, args.max_len, strategy, input_template=args.input_template, output_template=args.output_template)
    eval_dataset = RewardDataset(eval_data, tokenizer, args.max_len, strategy, input_template=args.input_template, output_template=args.output_template)
