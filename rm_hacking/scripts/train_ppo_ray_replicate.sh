...
exp_name=PPO_ray_kl${kl}_${base_model}_${data_name}_bsz${bsz}-${mbsz}_rollout${rollout_bsz}-${rollout_mbsz}_alr${actor_lr}_clr${critic_lr}_eval${eval_number}-orc-step${eval_steps}_eval-kl-step${eval_steps}_RUN${run_id}
...
oracle_data_dir=${working_dir}/data/uf1024-N1-PPO_ray_kl0_Llama-3.2-1B-sft-full_uf-ArmoRM-Llama3-8B-v0.1_bsz128-8_rollout1024-16_alr5e-7_clr9e-6_eval1024-orc-step2
